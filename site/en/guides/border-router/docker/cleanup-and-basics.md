...
Docker](/guides/border-router/docker/run) and [Test
Connectivity](/guides/border-router/docker/test-connectivity) to restart OTBR
Docker.
...
network](/guides/border-router/docker/test-connectivity#join_the_second_node_to_the_thread_network).
...
Overview](/guides/border-router/docker/).
